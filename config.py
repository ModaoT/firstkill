...
flags.DEFINE_integer('data_source', 5, '数据源：1，lgb精简特征2162维；2，lgb精简特征4236维；3，lgb精简特征6789维；4，lgb精简特征9098维；5，lgb精简特征13475维')
flags.DEFINE_integer('feature', 1, '选择数据类型：1，经lgb筛选过的特征；2，list特征映射为hash等长向量')  # 从调试结果看，hash效果不好
...
flags.DEFINE_integer('summary', 500, '每隔多少个批次记录一次日志')
...
flags.DEFINE_string('logdir', 'logdir_lgb_3_f1_13475', '日志保存路径')
